<#  
    ...
    Comment:        Changes from Version 2.1.1 to 3.0.0
                    -Added option to log telemetry to a separate Log Analytics Workspace. To enable this functionality you need to create a Log Analytics workspace 
                     Create two new Application Setting Keys in the Azure Function Application Settings section
                     "TelemetryWorkspace" Store your LA Workspace ID in this field 
                     "TelemetryWorkspaceKey" Store your LA Workspace Key in this field
                    ...
                    Changes from Version 2.0.0 to 2.1.1
